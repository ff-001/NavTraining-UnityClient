...
public class PlayerController : MonoBehaviour
{
	...
	//  Send four rays to detection the surrounding objects of player during the player move.
	...
	//  Return the surrounding objects name and display them to user if user press ‘Information’ button.
	...
	// Manage the movement in the scene display mode, move forword and move back.
	...
	//  Manage the movement in the Oculus display mode, move forword, move back and turn.
